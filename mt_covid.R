...
output_path <- c("C:/R/personal_projects/")
...
county_data_combined <- plyr::rbind.fill(missoula_county, gallatin_county,
  ...
  mutate("Cumulative total cases" = cumsum(`Daily total cases`),
         ...
         "Cumulaative deseased cases" = cumsum(Deceased)) 

write_csv(county_data_combined, paste0(output_path, "Output/county_data_combined.csv"), na = "0")
...
write_csv(case_hosp_test_outcome, paste0(output_path, "Output/case_hosp_test_outcome_data.csv"), na = "0")
